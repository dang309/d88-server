...
export interface ApiBetBet extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<"api::bet.bet", "oneToOne", "plugin::users-permissions.user">;
    amount: Attribute.Decimal;
    value: Attribute.String;
    type: Attribute.Enumeration<["handicap", "overUnder"]>;
    winOrLoseType: Attribute.Enumeration<["draw", "winFull", "winHalf", "loseFull", "loseHalf"]>;
    profit: Attribute.Decimal;
    loss: Attribute.Decimal;
    handicap: Attribute.Component<"bet.handicap">;
    overUnder: Attribute.Component<"bet.over-under">;
    isCelebrated: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::bet.bet", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::bet.bet", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiMatchMatch extends Schema.CollectionType {
  ...
  attributes: {
    firstTeamName: Attribute.String;
    secondTeamName: Attribute.String;
    topTeamName: Attribute.String;
    type: Attribute.Enumeration<["group", "roundOf16", "quarter", "semi", "final"]>;
    firstTeamFlag: Attribute.String;
    secondTeamFlag: Attribute.String;
    result: Attribute.Component<"match.result">;
    handicap: Attribute.Component<"bet.handicap", true>;
    overUnder: Attribute.Component<"bet.over-under", true>;
    datetime: Attribute.DateTime;
    code: Attribute.UID;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::match.match", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::match.match", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiPredictionPrediction extends Schema.CollectionType {
  ...
  attributes: {
    user: Attribute.Relation<"api::prediction.prediction", "oneToOne", "plugin::users-permissions.user">;
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    user: Attribute.Relation<"api::transaction.transaction", "oneToOne", "plugin::users-permissions.user">;
    amount: Attribute.Integer;
    type: Attribute.Enumeration<["recharge", "withdraw"]>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::transaction.transaction", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::transaction.transaction", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
